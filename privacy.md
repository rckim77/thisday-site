...
- Convert Live Photos to still photos only when you explicitly choose conversion actions
- Export selected items to the iOS share sheet when you explicitly choose share actions
- Add selected items to an editable Photos album when you explicitly choose the Add to Album share action
...
### d) Analytics and crash diagnostics

This Day uses Firebase Analytics to understand app usage and improve the product. Analytics events may include app screens viewed and in-app actions such as reminder interactions, duplicate detection and review usage, Live Photo conversion, Add to Album share actions, Achievements and streak activity, premium paywall interactions, and cleanup progress events.

This Day also uses Firebase Crashlytics to help diagnose crashes and stability issues. Firebase may process related app instance, device, crash, and diagnostic data needed to provide these services.
...
- Streak, Achievements, and milestone progress
...
- Enabling deletion, Live Photo conversion, album, and sharing actions you request
- Providing reminders and streak, Achievements, and milestone progress
...
- Google Firebase, for product analytics and crash diagnostics
