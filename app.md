  ...
  <div class="feature-carousel" data-feature-carousel>
    <div class="feature-stage">
      <div class="feature-visual">
        <div class="feature-visual-viewport" data-feature-visual-viewport>
          <figure class="feature-slide is-active" data-feature-visual-slide>
          ...
          <figure class="feature-slide" data-feature-visual-slide>
      ...
      <div class="feature-controls" aria-label="Feature carousel controls">
        <button type="button" class="feature-nav" data-feature-prev aria-label="Previous feature">
          <svg class="feature-nav-icon" width="10" height="16" viewBox="0 0 10 16" aria-hidden="true" focusable="false">
            <path d="M8.5 1.5 2 8l6.5 6.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </button>
        ...
        <button type="button" class="feature-nav" data-feature-next aria-label="Next feature">
          <svg class="feature-nav-icon" width="10" height="16" viewBox="0 0 10 16" aria-hidden="true" focusable="false">
            <path d="M1.5 1.5 8 8l-6.5 6.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </button>
      </div>

      <div class="feature-copy">
        <div class="feature-copy-viewport" data-feature-copy-viewport>
          <article class="feature-panel is-active" data-feature-copy-slide>
          ...
          <article class="feature-panel" data-feature-copy-slide>
...
<section id="premium" class="section section--muted">
  <div class="container">
    <header class="section-header">
      ...
      <p>More tools for deeper cleanup—when you are ready to go further.</p>
    </header>
    <div class="premium-layout">
      <div class="premium-benefits">
        <ul class="premium-benefits-list">
          <li>
            <span class="premium-check" aria-hidden="true">✓</span>
            <span><strong>Load all your past memories</strong> — reach further back in your library, not just recent years.</span>
          </li>
          <li>
            <span class="premium-check" aria-hidden="true">✓</span>
            <span><strong>Convert unlimited Live Photos</strong> — turn Live Photos into stills and reclaim storage at scale.</span>
          </li>
          <li>
            <span class="premium-check" aria-hidden="true">✓</span>
            <span><strong>Delete unlimited duplicates</strong> — find and clear exact duplicates without hitting limits.</span>
          </li>
          <li>
            <span class="premium-check" aria-hidden="true">✓</span>
            <span><strong>Filter by more options</strong> — narrow results (e.g., video only) to focus each session.</span>
          </li>
          <li>
            <span class="premium-check" aria-hidden="true">✓</span>
            <span><strong>Unlock premium app icons</strong> — personalize This Day on your Home Screen.</span>
          </li>
        </ul>
      </div>
      <figure class="premium-visual">
        <img
          ...
          alt="This Day Premium unlock screen listing included features"
          width="405"
          height="828"
          loading="lazy"
        >
